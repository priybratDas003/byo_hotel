							...
							<div class="row no-margin">
								<div class="col-md-4 location-open">
									<div class="form-group" style="padding-top: 25px">
										...
										<input type="text" autocomplete="off" onkeyup="searchCity(this.value)" name="destination" id="destination" placeholder="Search by city, hotel, or neighborhood" class="form-control txtf1" required />                                
								...
								<div class="col-md-6">
									<div class="col-md-12">
										...
										<div class="col-md-4 getData">
											<div class="form-group">
												<span class="form-label">Check In</span>
												 ...
												 <input type="text" class="form-control txtf2" style="text-align: center" id="checkincheckout" name="daterange" value="<?php echo date('m/d/Y'); ?>" required />
										...
										<div class="col-md-4">
											<div class="">
											<span class="form-label" style="padding-top: 5px;">Guests</span>
									...
									<label class="xp__input">
										...
										<span class="xp__guests__count">
											...
											<span>
												<!-- &nbsp;·&nbsp; -->
												<span id="roomSetCount">1</span>
												<span data-room-count="">Room</span>
											</span>
											&#x2c;
											<span id="adultSetCount">1</span>
											<span>Guests</span>
										</span>
								</label>
								</div>
								<div class="guest_container" style="width: 240px">
									...
									<div id="adult" class="clear-divs"><span class="pull-left">Guests</span>
										...
										<input type="text" id="adultCount" name="adultCount" value="1" class="input-design" />
